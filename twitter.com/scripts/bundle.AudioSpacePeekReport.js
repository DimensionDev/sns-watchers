  ...
  [36],
  {
    ...
    KkRJ: function (t, e, n) {
      ...
      function h(t) {
        var e = t.audioSpaceId,
          ...
          i = r.a.createElement(u.a, { autofocus: !0, backButtonType: 'back', onClick: n })
        return r.a.createElement(
          ...
          r.a.createElement(
            ...
            r.a.createElement(l.a, {
              leftControl: i,
              style: v.appBar,
              subtitle: f.c.describeTheIssue,
              title: f.c.reportThisSpace,
              withGutter: !0,
            }),
            r.a.createElement(d, { audioSpaceId: e, returnToPreview: n }),
          ),
        )
      }
      function d(t) {
        var e = t.audioSpaceId,
          n = t.returnToPreview,
          i = f.a.useReportingItems({ audioSpaceId: e })
        return r.a.createElement(
          s.a,
          { style: v.actionList },
          i.map(function (t) {
      ...
      var v = p.a.create(function (t) {
        return {
          root: { paddingBottom: t.spaces.space56 },
          appBar: { paddingVertical: t.spaces.space8 },
          actionList: { marginTop: t.spaces.space20 },
        }
      })
      h.ActionList = d
      var m = n('Z5jE')
      function g(t) {
        var e = Object(m.a)(t.match)
        return r.a.createElement(h, { audioSpaceId: e })
      }
    },
    MQi0: function (t, e, n) {
      'use strict'
    ...
    WrBE: function (t, e, n) {
        ...
        spring: function t(e, n) {
          var i = function (t, e, n) {
            ...
            var i = t,
              r = e
            i.stopTracking(),
              e.toValue instanceof f.a ? i.track(new It(i, e.toValue, Rt.a, r, n)) : i.animate(new Rt.a(r), n)
          }
          return (
            qt(e, n, t) || {
              start: function (t) {
      ...
      var te = (function (t) {
        ...
        return t
      })({ FlatList: F, Image: M, ScrollView: B, SectionList: pt, Text: ft, View: ht }, i.a.isTesting ? Zt : Jt)
      e.a = te
    },
    XJEr: function (t, e, n) {
      'use strict'
    ...
    jtO7: function (t, e, n) {
      ...
      e.a = function (t) {
        ...
        return u.a.createElement(
          ...
          u.a.createElement(
            _.a,
            r()({}, s, { interactiveStyles: v, style: d.root }),
            u.a.createElement(c.b, { align: n, color: i }, a),
          ),
        )
      }
    },
