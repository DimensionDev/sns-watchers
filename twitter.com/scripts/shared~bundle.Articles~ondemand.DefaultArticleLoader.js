  ...
  [18],
  {
            ...
            c()(a, [
              {
                ...
                value: function () {
                  var e = this,
                    ...
                    O = H.viewStyle
                  return R
                    ? g.a.createElement(w.b.UseProps, null, function (t) {
              ...
              },
              {
                ...
                value: function (e, t) {
                  var a = this.props,
                    ...
                    c = a.topicData,
                    s = (o || {}).screenName,
                    u = g.a.createElement(v.b, { color: l, link: e, nativeID: r, onClick: i }, t)
                  return n === C.a.Topic && c
                    ? g.a.createElement(k.a, { topicId: c.topicId }, u)
                    : n === C.a.Retweet && s
                    ? g.a.createElement(L.a, { screenName: s }, u)
                    : u
                },
              },
              {
    ...
    qjak: function (e, t, a) {
      ...
      t.a = function (e) {
        var t = e.contextType,
          ...
          C = (function (e, t) {
            var a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : [],
              ...
              w = r.a.createElement(g.a, { style: V.circle }),
              f = r.a.createElement(v.a, { style: i }),
        ...
        switch (t) {
          case c.a.Retweet:
            return { Icon: C, text: l || K(w, x), link: f ? 'https://twitter.com/'.concat(f) : void 0 }
          case c.a.Pin:
      ...
      t.a = Object(k.a)(
        x(function (e) {
          var t = e.adFreeDomains,
            ...
            V = [q.domain, q.timestamp, q.title, q.description, q.socialContext],
            W = h.isTrueAndEnabled('subscriptions_feature_1006'),
            G = !!W && Object(P.c)(t, w),
            X = c.a.useMemo(
              function () {
                ...
                return {
                  url: g,
                  items: [
                    Object(A.a)({}, e, { article_details: { publisher_name: x, is_showing_label: G, is_ad_free: G } }),
                  ],
                }
              },
              [p.contextualScribeData.items, g, x, G],
            ),
            Q = c.a.useCallback(
              function () {
          ...
          var J,
            ...
            ee = Z.landingUrl,
            te = Z.text,
            ae = f ? { url: f, height: 750, width: 1250 } : void 0,
            ne = { pathname: g, external: !0 },
            re = function (e) {
              if ((p.scribe({ element: m ? 'read_article' : 'article_header', action: 'open_link', data: X }), W)) {
            ...
            se = c.a.createElement(
              ...
              c.a.createElement(
                ...
                c.a.createElement(
                  ...
                  v ? c.a.createElement(B.b, { nativeID: q.description, numberOfLines: 2 }, v) : null,
                  G && c.a.createElement(E.a, { style: N.adFreeLabel }, c.a.createElement(F.a, null)),
                  m
                    ? c.a.createElement(
                        E.a,
