            ...
            return r().countryNames.fetchStatus === i.a.LOADED
              ...
              : (n({ type: d.REQUEST }),
                (function (e) {
                  switch (e) {
                    case 'ar':
                      return a.e(251).then(a.t.bind(null, 'heBS', 3))
                    case 'bg':
                      return a.e(252).then(a.t.bind(null, '9kpF', 3))
                    case 'bn':
                      return a.e(253).then(a.t.bind(null, 'GG9y', 3))
                    case 'ca':
                      return a.e(254).then(a.t.bind(null, 'icrD', 3))
                    case 'cs':
                      return a.e(255).then(a.t.bind(null, 'rxOR', 3))
                    case 'da':
                      return a.e(256).then(a.t.bind(null, '6Nxr', 3))
                    case 'de':
                      return a.e(257).then(a.t.bind(null, 'zSOo', 3))
                    case 'el':
                      return a.e(258).then(a.t.bind(null, 'MOmn', 3))
                    case 'en-GB':
                      return a.e(260).then(a.t.bind(null, 'vzeG', 3))
                    case 'en':
                      return a.e(259).then(a.t.bind(null, 'WqZ6', 3))
                    case 'es':
                      return a.e(261).then(a.t.bind(null, 'v4/g', 3))
                    case 'eu':
                      return a.e(262).then(a.t.bind(null, 'KXIK', 3))
                    case 'fa':
                      return a.e(263).then(a.t.bind(null, 'vzCi', 3))
                    case 'fi':
                      return a.e(264).then(a.t.bind(null, 'YthM', 3))
                    case 'fil':
                      return a.e(265).then(a.t.bind(null, 'AcRS', 3))
                    case 'fr':
                      return a.e(266).then(a.t.bind(null, 'PuNY', 3))
                    case 'ga':
                      return a.e(267).then(a.t.bind(null, 'FSy8', 3))
                    case 'gl':
                      return a.e(268).then(a.t.bind(null, 'igcB', 3))
                    case 'gu':
                      return a.e(269).then(a.t.bind(null, 'DaQw', 3))
                    case 'he':
                      return a.e(270).then(a.t.bind(null, '8mgg', 3))
                    case 'hi':
                      return a.e(271).then(a.t.bind(null, 'w88S', 3))
                    case 'hr':
                      return a.e(272).then(a.t.bind(null, 'dvLs', 3))
                    case 'hu':
                      return a.e(273).then(a.t.bind(null, '9fGX', 3))
                    case 'id':
                      return a.e(274).then(a.t.bind(null, 'elf3', 3))
                    case 'it':
                      return a.e(275).then(a.t.bind(null, 'sxFK', 3))
                    case 'ja':
                      return a.e(276).then(a.t.bind(null, '1/Dg', 3))
                    case 'kn':
                      return a.e(277).then(a.t.bind(null, 'nFOI', 3))
                    case 'ko':
                      return a.e(278).then(a.t.bind(null, 'RRUG', 3))
                    case 'mr':
                      return a.e(279).then(a.t.bind(null, 'EpxJ', 3))
                    case 'ms':
                      return a.e(280).then(a.t.bind(null, 'cSS2', 3))
                    case 'nb':
                      return a.e(281).then(a.t.bind(null, 'bg3k', 3))
                    case 'nl':
                      return a.e(282).then(a.t.bind(null, 'eXnI', 3))
                    case 'pl':
                      return a.e(283).then(a.t.bind(null, 'ACpo', 3))
                    case 'pt':
                      return a.e(284).then(a.t.bind(null, 'J0At', 3))
                    case 'ro':
                      return a.e(285).then(a.t.bind(null, 'hxXa', 3))
                    case 'ru':
                      return a.e(286).then(a.t.bind(null, 'gXfs', 3))
                    case 'sk':
                      return a.e(287).then(a.t.bind(null, 'fy2h', 3))
                    case 'sr':
                      return a.e(288).then(a.t.bind(null, 'FmvU', 3))
                    case 'sv':
                      return a.e(289).then(a.t.bind(null, 'prb2', 3))
                    case 'ta':
                      return a.e(290).then(a.t.bind(null, '8KkY', 3))
                    case 'th':
                      return a.e(291).then(a.t.bind(null, 'g4c5', 3))
                    case 'tr':
                      return a.e(292).then(a.t.bind(null, 'NngR', 3))
                    case 'uk':
                      return a.e(293).then(a.t.bind(null, '62bs', 3))
                    case 'ur':
                      return a.e(294).then(a.t.bind(null, 'aKQ3', 3))
                    case 'zh-Hant':
                      return a.e(296).then(a.t.bind(null, 'Wk8C', 3))
                    case 'zh':
                      return a.e(295).then(a.t.bind(null, 'YXaK', 3))
                    default:
