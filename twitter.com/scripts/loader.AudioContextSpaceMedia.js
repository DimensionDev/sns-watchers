    ...
    BXJq: function (t, e, n) {
      ...
      function u(t) {
        var e = Object(s.a)(t),
          ...
          c = u[0],
          l = u[1],
          _ = { hasReminderSet: !1, onClick: void 0, scheduledStart: void 0 }
        return (
          (function (t) {
            return t && t.host && t.scheduled_start && ('NotStarted' === t.state || 'PrePublished' === t.state)
          })(i) &&
            ((_.hasReminderSet = Boolean(null == i ? void 0 : i.is_subscribed)),
            (_.onClick = function () {
              var t = function () {
                return l(!1)
              }
              l(!0), _.hasReminderSet ? n.unsubscribe().finally(t) : n.subscribe().finally(t)
            }),
            (_.scheduledStart = null == i ? void 0 : i.scheduled_start)),
          { props: _, isSubscribing: c }
        )
      }
    },
    BtOK: function (t, e, n) {
    ...
    MQi0: function (t, e, n) {
      ...
      e.a = {
        ...
        fromBouncinessAndSpeed: function (t, e) {
          ...
          return { stiffness: i(_), damping: r(p) }
        },
      }
    },
    U1mC: function (t, e, n) {
      ...
      var i = n('RhWx'),
        ...
        s = n('yiKp'),
        u = n.n(s),
        c = (n('7xRU'), n('M+/F'), n('LW0h'), n('7x/C'), n('2G9S'), n('ERkP')),
        l = n.n(c),
        _ = n('v6aA'),
        p = n('B/Qy'),
        f = n('vYiB'),
        ...
        g = function (t) {
          var e,
            n = l.a.useContext(_.a).featureSwitches,
            i = Object(p.a)(t.audioSpaceId),
            a = Object(d.a)(t.audioSpaceId),
            s = a.handlers,
            c = a.space,
            h = a.utils,
            g = h.state() === m.a.StateEnum.unavailable,
            b = Object(v.a)(t.audioSpaceId),
            O = {}
          O =
            !1 === t.isInteractive
              ? { link: void 0, onButtonClick: void 0 }
              : null != c && c.ticket_group_id
              ? { link: i, withoutButton: !0 }
              : (t.withDirectJoin && h.is.Running) || h.is.replayable
              ? {
                  onClick: function () {
                    return s.join('card')
                  },
                }
              : { link: i, onButtonClick: b.props.onClick }
          var N = h.state(),
            w = (function (t) {
              return t ? [t.host].concat(r()(t.cohosts), r()(t.participants.speakers)).filter(Boolean) : []
            })(c),
            V = u()(
              {
                disabled: b.isSubscribing,
                hasReminderSet: b.props.hasReminderSet,
                scheduledStart: b.props.scheduledStart,
                isJoined: h.is.joined,
                title: h.title(),
            ...
            j = A.ended_at,
            P = A.started_at
          P && j && ((V.replayStartTime = P), (V.replayDuration = j - P))
          var S = { shouldUseV2: !1, propsForV2: void 0 }
          2 === n.getValue('voice_rooms_card_version') &&
            ((S.shouldUseV2 = !0),
            (S.propsForV2 = u()(
              u()({}, V),
              {},
            ...
            h.is.joined && h.is.replayable && (S.propsForV2.button = l.a.createElement(y, S.propsForV2)))
          return l.a.createElement(
            f.a,
            {
              onImpression: function () {
                h.scribe('::::audiospace_card:impression')
              },
            },
            l.a.createElement(
              m.a,
              o()(
                {
                  ...
                  isReplay: N === m.a.StateEnum.replay,
                  isUnavailable: g,
                  participants: w,
      ...
      function y(t) {
        var e = h.a.usePlayButtonProps(),
          n = e.isPlaying,
          i = e.togglePlayback
        return l.a.createElement(m.a.ButtonV2, o()({}, t, { onButtonClick: i, replayIsPlaying: n }))
      }
    },
    WrBE: function (t, e, n) {
      'use strict'
            ...
            (u.render = function () {
              var n,
                ...
                d = (
                  ...
                  : {}
              return r.createElement(t, E({}, u, p, d, { style: f, ref: this._setComponentRef }))
            }),
      ...
      var q = L(
          r.forwardRef(function (t, e) {
            return r.createElement(M.a, B({ scrollEventThrottle: 1e-4 }, t, { ref: e }))
          }),
          { collapsable: !1 },
        ),
        H = n('MWbm'),
        ...
        qt = function t(e, n) {
          var i = function (t, e, n) {
            ...
            var i = t,
              r = e
            i.stopTracking(),
              e.toValue instanceof f.a ? i.track(new It(i, e.toValue, Lt.a, r, n)) : i.animate(new Lt.a(r), n)
          }
          return (
            Bt(e, n, t) || {
              start: function (t) {
        ...
        spring: function t(e, n) {
          var i = function (t, e, n) {
            ...
            var i = t,
              r = e
            i.stopTracking(),
              e.toValue instanceof f.a ? i.track(new It(i, e.toValue, xt.a, r, n)) : i.animate(new xt.a(r), n)
          }
          return (
            Bt(e, n, t) || {
              start: function (t) {
      ...
      var te = (function (t) {
        ...
        return t
      })({ FlatList: F, Image: U, ScrollView: q, SectionList: pt, Text: ft, View: ht }, i.a.isTesting ? Qt : Wt)
      e.a = te
    },
    XJEr: function (t, e, n) {
      'use strict'
        ...
        var c = (function (e) {
          ...
          function a(t) {
            ...
            if (
              ...
              (f._initialVelocity = null !== (u = t.velocity) && void 0 !== u ? u : 0),
              (f._lastVelocity = null !== (c = t.velocity) && void 0 !== c ? c : 0),
              (f._toValue = t.toValue),
              (f._delay = null !== (l = t.delay) && void 0 !== l ? l : 0),
              (f._useNativeDriver = Object(s.c)(t)),
              (f.__isInteraction = null !== (_ = t.isInteraction) && void 0 !== _ ? _ : !f._useNativeDriver),
              ...
              o()(
                ...
                (f._damping = null !== (d = t.damping) && void 0 !== d ? d : 10),
              ...
              ;(f._stiffness = N.stiffness), (f._damping = N.damping), (f._mass = 1)
            }
            return (
          ...
          return (
            ...
            (c.onUpdate = function () {
              ...
              if (o < 1) {
                ...
                ;(l = this._toValue - f * (((a + o * s * c) / u) * Math.sin(u * p) + c * Math.cos(u * p))),
                  (_ =
                    o * s * f * ((Math.sin(u * p) * (a + o * s * c)) / u + c * Math.cos(u * p)) -
                    f * (Math.cos(u * p) * (a + o * s * c) - u * c * Math.sin(u * p)))
              } else {
                var h = Math.exp(-s * p)
                ;(l = this._toValue - h * (c + (a + s * c) * p)), (_ = h * (a * (p * s - 1) + p * c * (s * s)))
              }
              if (
                ((this._lastTime = t),
