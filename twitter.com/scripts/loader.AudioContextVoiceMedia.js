  ...
  [169],
  {
      ...
      var i = n('yiKp'),
        ...
        _ = function (t) {
          var e = (function (t) {
            var e = Object(u.a)(),
              n = t.tweet,
              i = t.withStraightBorders,
              a = e.activeItem && e.activeItem.id === n.id_str,
              _ = a && e
            return o.a.useMemo(
              function () {
                var o = e.player.api,
                  u = e.player.state,
                  _ = e.player.currentTrack
                return a && l.a.hasVoiceMedia(n) && u && o && _
                  ? r()(
                      r()(
                        {
                          tweet: n,
                          withStraightBorders: i,
                          isMuted: u.isMuted,
                          isPlaying: u.isPlaying,
                          progressMs: _.currentTimeMs || 0,
                          durationMs: _.durationMs,
                        },
                        (function (t) {
                          var e,
                            n = { captionsState: c.a.CaptionsState.unavailable, caption: void 0 },
                            i = t.player.currentTrack
                          if (i)
                            if (i.hasCaptions)
                              if (null !== (e = t.player.state) && void 0 !== e && e.areCaptionsShown) {
                                var r
                                ;(n.captionsState = c.a.CaptionsState.on),
                                  (n.caption =
                                    i.textCues && (null === (r = i.textCues[0]) || void 0 === r ? void 0 : r.text))
                              } else n.captionsState = c.a.CaptionsState.off
                            else n.captionsState = c.a.CaptionsState.unavailable
                          return n
                        })(e),
                      ),
                      {},
    ...
    WrBE: function (t, e, n) {
      ...
      var te = (function (t) {
        ...
        return t
      })({ FlatList: F, Image: M, ScrollView: B, SectionList: pt, Text: ft, View: ht }, i.a.isTesting ? Zt : Yt)
      e.a = te
    },
    XJEr: function (t, e, n) {
      'use strict'
