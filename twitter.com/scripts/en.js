    ...
    [106],
    {
      ...
      oTxr: function (e, t, o) {
        ...
        n('b982a8b4', 'This can only be changed a few times.'),
          ...
          n(
            'g8f8fd07',
            'When you turn on Tweet notifications from people you follow, you’ll get notifications about their Tweets or live videos. These will be push or SMS notifications, depending on your settings.',
          ),
          n('b68050dc', 'View users'),
          n('b96cf52d', 'SMS notifications'),
          n('c7d36299', 'Phone number'),
          n('bdc43b51', 'SMS not available'),
          n(
            'df086319',
            'You need to update your account by adding a phone number that can receive text messages first.',
          ),
          n('ca1c1d59', 'Update number'),
          n('ad273880', 'Learn more'),
        ...
        var l = o('KQqj')
        o('5hi7'), o('7TW0'), o('yluK'), o('AfUj'), o('Fr/T')
        l._validateParameterTypeNumber, l._validateParameterPresence
        var h = l._numberRound,
          b = (l._numberFormat, l._numberFormatterFn),
          y = l._pluralGeneratorFn,
          m = (l._validateParameterTypeDate, l._dateToPartsFormat, l._dateToPartsFormatterFn),
          w = (l._dateFormat, l._dateFormatterFn),
          p = l._relativeTimeFormatterFn,
          g = l._unitFormatterFn
        ;(l.b468386326 = b([
          '',
          ,
          1,
          ...
          (l.b696469024 = m({ 1: l('en').numberFormatter({ raw: '0' }) }, { pattern: 'y', timeSeparator: ':' })),
          (l.a481468996 = m(
            { 1: l('en').numberFormatter({ raw: '0' }), 2: l('en').numberFormatter({ raw: '00' }) },
            {
          ...
          (l.b687161418 = p(l('en').numberFormatter({}), l('en').pluralGenerator({}), {
          ...
          (l.a2110709659 = g(l('en').numberFormatter({}), l('en').pluralGenerator({}), {
          ...
          (l.a223746363 = g(l('en').numberFormatter({}), l('en').pluralGenerator({}), {
            compoundUnitPattern: '{0} per {1}',
            unitProperties: {
              displayName: 'minutes',
              one: '{0} minute',
          ...
          (l.b2116965749 = g(l('en').numberFormatter({}), l('en').pluralGenerator({}), {
            compoundUnitPattern: '{0} per {1}',
            unitProperties: {
              displayName: 'hours',
              one: '{0} hour',
          ...
          (l.a211373797 = g(l('en').numberFormatter({}), l('en').pluralGenerator({}), {
            compoundUnitPattern: '{0}/{1}',
            unitProperties: { displayName: 'yr', one: '{0}y', other: '{0}y', perUnitPattern: '{0}/y' },
          })),
          (l.b636176220 = g(l('en').numberFormatter({}), l('en').pluralGenerator({}), {
            compoundUnitPattern: '{0} per {1}',
            unitProperties: {
              displayName: 'years',
              one: '{0} year',
          ...
          (l.b1554153647 = g(l('en').numberFormatter({}), l('en').pluralGenerator({}), {
            compoundUnitPattern: '{0}/{1}',
            unitProperties: { displayName: 'secs', one: '{0} sec', other: '{0} sec', perUnitPattern: '{0}/s' },
          })),
          (l.a79526321 = g(l('en').numberFormatter({}), l('en').pluralGenerator({}), {
            compoundUnitPattern: '{0}/{1}',
            unitProperties: { displayName: 'mins', one: '{0} min', other: '{0} min', perUnitPattern: '{0}/min' },
          })),
          (l.a531894881 = g(l('en').numberFormatter({}), l('en').pluralGenerator({}), {
            compoundUnitPattern: '{0}/{1}',
...
//# sourceMappingURL=https://ton.twitter.com/responsive-web-internal/sourcemaps/client-web-legacy/en.917af175.js.map
