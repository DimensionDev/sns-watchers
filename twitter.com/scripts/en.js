  ...
  ['i18n/en'],
  {
    417346: function _(e, t, o) {
      ...
      a('d2fb334c', 'Twitter'),
        ...
        a('cc85b9f6', 'Your account is suspended and is not permitted to send Tweets.'),
        a('a3f10d62', 'The Tweet you are trying to reply to has been deleted or is not visible to you.'),
        a('d74da9b8', 'The text of your Tweet exceeds the number of allowed @mentions.'),
        a('c3ebec64', 'The text of your Tweet exceeds the number of allowed URLs.'),
        a('b6266b34', 'The text of your Tweet exceeds the number of allowed hashtags.'),
        a('a59566d8', 'The text of your Tweet exceeds the number of allowed cashtags.'),
        a('g30d7ec6', 'The text of your Tweet contains a hashtag that is longer than allowed.'),
        a('d484fcaa', 'The Tweet exceeds the number of allowed attachment types.'),
        ...
        a('h96ba9b6', 'An official website of an advocacy organization that references you and your Twitter account.'),
        a(
          'e4610048',
        ...
        a('i97c0926', 'Notable individuals using Twitter to bring about socioeconomic, political, or cultural change.'),
      ...
      a('g1888dc2', 'Never'),
        ...
        a('e0fef90a', 'Keep it up! The more Tweets you like, the better your timeline will be.'),
        a(
          'def4a37c',
        ...
        a(
          'j991cb30',
          'Never miss out on what’s happening by enabling Twitter notifications. Twitter will receive your device country and language to personalize your notifications.',
        ),
        ...
        a('bbbfc828', 'Can’t like Tweets of protected users you aren’t following.'),
        ...
        a('afbe43d8', 'Why can’t you retweet this?'),
        a('dcc05a7e', 'Views'),
        ...
        a(
          'e2d72d22',
          'Twitter Blue subscribers get early access to features like Edit Tweet, which lets you update a Tweet up to 5 times within the first 1 hour after it’s published.',
        ),
        ...
        a('aa38e198', 'Edit with Twitter Blue'),
        ...
        a('c778d97a', 'This Tweet would be featured in the Highlights tab on your profile.'),
        a('gf124a22', 'This Tweet would be removed from the Highlights tab on your profile.'),
        ...
        a('g9425e30', 'Are you sure you want to remove the photo tag from this Tweet?'),
        ...
        a('had58d00', 'You’ll need to log in before you can share that Tweet.'),
        a('ja03b44e', 'Something went wrong. Try reacting to the Tweet again in a minute.'),
        a('da5c4380', 'Can’t react to Tweets of protected users you aren’t following.'),
        a('f03dab2a', 'You have been blocked from reacting to this user’s Tweets at their request.'),
        ...
        a('g6fc48fa', 'Your Tweet was sent. You have 30 minutes to make any edits.'),
        a('jc3c5f90', 'Your Tweet was sent. You have 1 hour to make any edits.'),
        a('e65aed64', 'Your Tweets were sent.'),
        a('f548d684', 'Sending Tweet ... once it’s published, you’ll have 30 minutes to make any edits.'),
        a('i982a04c', 'Sending Tweet ... once it’s published, you’ll have 1 hour to make any edits.'),
        ...
        a('ie18da20', 'Tweets can only be edited within the first 1 hour after they’re published.'),
        a('g4bcc5f4', 'This is your last edit'),
        a('c5b474de', 'Your Tweet can’t be updated again.'),
      ...
      a('ha5e2e7a', 'Schedule Tweet'),
        ...
        a('ae42ebf0', 'We’re asking Tweeters to review replies with potentially harmful or offensive language.'),
        ...
        a(
          'f28690ae',
          'As a Blue subscriber, your blue checkmark will be hidden for a period of time after you edit your display name or profile photo until it is reviewed.',
        ),
        a(
          'addbe8e8',
        ...
        a('jf4e00e2', 'This is a pretty common word, and shows up in lots of Tweets, but you can mute it if you want.'),
        ...
        a('d4cca0f8', 'This will end your active Twitter session, and you’ll need to log in again to start a new one.'),
        ...
        a(
          'h6740c9a',
          'Edit Tweets up to 5 times within 1 hour of Tweeting. Your edit history is visible to anyone who wants to see the evolution of a Tweet.',
        ),
      ...
      a('g6d44432', 'A managing account is the human-run account responsible for the automated account.'),
        ...
        a('bcd14748', 'Is your note about the Tweet or the video?'),
        ...
        a('c16d8982', 'About the video in this Tweet, and should appear on all Tweets that include this video'),
        ...
        a('g48064a8', 'If your note earns a status of Helpful, it will start showing on Twitter as context'),
        ...
        a('j5a00a2a', 'Not shown on Twitter'),
        ...
        a('ac8bae68', 'This note is about the image and could be shown on other Tweets that include this image'),
        ...
        a(
          'ae5fa4b2',
          'As a Twitter Blue subscriber, you can customize your navigation in your mobile app’s Settings › Twitter Blue › Extras.',
        ),
        a(
          'd4945e44',
      ...
      a('fd6c37ec', 'Your Twitter Circle is full. You’ve reached the maximum of 150 people in your Twitter Circle.'),
        ...
        a('iee9167a', 'Don’t want to promote this Tweet?'),
        a('ff6a9aaa', 'If you leave now this Tweet won’t be promoted.'),
        ...
        a('j59b58de', 'Twitter List Search'),
        a('h363d253', function (e) {
          return e.query + ' - Twitter List Search'
        }),
        ...
        a(
          'gf2d1998',
          'You will be able to leverage all the benefits of Twitter Blue, but your organization will not receive a gold or grey checkmark and you will not be able to add affiliated accounts until your account is approved.',
        ),
        ...
        return (
          ...
          (i = [
            ...
            },
            {
              key: 'gee7fae9',
              get: function get() {
                return ['You’ll need to meet specific requirements depending on the type of Twitter account you have. ']
              },
            },
            {
              key: 'd454b49f',
            ...
            },
            {
              ...
              get: function get() {
                return [
                  'Replying to ',
                  '. ' + this.props.trustedFriendsTweetOwner + '’s Twitter Circle will also be able to see your reply.',
                ]
              },
            },
            {
            ...
            },
            {
              key: 'd9ebec8d',
              get: function get() {
                return ['Twitter uses your age to customize your experience, including ads, as explained in our ', '.']
              },
            },
            {
              key: 'fad15501',
            ...
            },
            {
              key: 'c5517273',
              get: function get() {
                return ['Times this Tweet was seen. To learn more, visit the ', '.']
              },
            },
            {
              key: 'c770501b',
              get: function get() {
                return [
                  'Times this Tweet was seen. It can take a few minutes for the view count to appear. To learn more, visit the ',
                  '.',
                ]
              },
            },
            {
              key: 'jaea7625',
              get: function get() {
                return ['View counts are not available for this Tweet. To learn more, visit the ', '.']
              },
            },
            {
              key: 'cace9785',
      ...
      ;(b.a527220190 = m(
        ...
        (b.a2110709659 = T(b('en').numberFormatter({}), b('en').pluralGenerator({}), {
        ...
        (b.a223746363 = T(b('en').numberFormatter({}), b('en').pluralGenerator({}), {
          compoundUnitPattern: '{0} per {1}',
          unitProperties: {
            displayName: 'minutes',
            one: '{0} minute',
        ...
        (b.a211373797 = T(b('en').numberFormatter({}), b('en').pluralGenerator({}), {
          compoundUnitPattern: '{0}/{1}',
          unitProperties: { displayName: 'yr', one: '{0}y', other: '{0}y', perUnitPattern: '{0}/y' },
        })),
        (b.b636176220 = T(b('en').numberFormatter({}), b('en').pluralGenerator({}), {
          compoundUnitPattern: '{0} per {1}',
