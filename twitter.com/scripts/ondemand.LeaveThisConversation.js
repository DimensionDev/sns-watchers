  ...
  [217],
  {
    ...
    qFUP: function (e, t, a) {
      ...
      var E = f,
        ...
        P = function () {
          return c.a.createElement(
            c.a.Fragment,
            null,
            c.a.createElement(s.b, null, v),
            c.a.createElement(
              r.a,
              { style: j.details },
              c.a.createElement(E, { style: j.icon }),
              c.a.createElement(
                r.a,
                null,
                c.a.createElement(s.b, { style: j.title }, L),
                c.a.createElement(s.b, null, A),
              ),
              c.a.createElement(y.a, { style: j.icon }),
              c.a.createElement(
                r.a,
                null,
                c.a.createElement(s.b, { style: j.title }, z),
                c.a.createElement(s.b, null, M),
              ),
              c.a.createElement(g.a, { style: j.icon }),
              c.a.createElement(
                r.a,
                null,
                c.a.createElement(s.b, { style: j.title }, k),
                c.a.createElement(s.b, null, C),
              ),
            ),
          )
        },
        ...
        R = function () {
          return c.a.createElement(s.b, { style: j.headline }, w)
        },
      ...
      t.a = function (e) {
        ...
        var s = l
            ? function (e) {
                r.scribeAction('secondary_cta'), null == l || l(e)
              }
            : void 0,
          m = n
            ? function () {
                r.scribeAction('close'), n()
              }
            : void 0
        return c.a.createElement(d.a, {
          actionLabel: t,
          footer: c.a.createElement(_, null),
          graphicDisplayMode: 'none',
          headline: c.a.createElement(R, null),
          isFullHeightOnMobile: !0,
          onAction: function (e) {
            r.scribeAction('primary_cta'), a(e)
          },
          onClose: m,
          onSecondaryAction: s,
          secondaryActionLabel: i,
          subtext: c.a.createElement(P, null),
          withBottomPadding: !0,
        })
      }
    },
