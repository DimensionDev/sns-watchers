;(window.webpackJsonp = window.webpackJsonp || []).push([
  [4],
  {
    ...
    I6Uj: function (t, e, n) {
      ...
      var v = function (t) {
          return r.a.createElement(f.a, {
            ...
            hoverLabel: { label: d },
            icon: r.a.createElement(_.a, null),
            onPress: t.onPress,
            pullRight: !0,
        ...
        C = ['isAvailable', 'scribeAction']
      function k(t) {
        var e = Object(V.b)()
        return {
          getActionItem: (function (t, e) {
            var n = Object(j.c)(),
              i = Object(P.f)()
            return r.a.useMemo(
              function () {
                return function (r) {
                  ...
                  var l = c()({}, u)
                  function p() {
                    var a = r.shareText || t.shareText,
                      o = t.url,
                      u = c()(c()({}, t.scribeNamespace), {}, { action: s }, r.scribeNamespace),
                      l = { text: a, url: o },
                      p = { analytics: e, dispatch: n, history: i, mergedScribeNamespace: u }
                    !(function (t, e, n) {
                      var i = function () {
                      ...
                      switch (t) {
                        case 'dm':
                          return i(), void n.history.push(c()(c()({}, L(e)), {}, { pathname: '/messages/compose' }))
                        case 'copy':
                          return (
                            N.a.setString(Object(w.a)(e.url)),
                            i(),
                            void n.dispatch(Object(O.b)({ text: x.copyLinkSuccessMessage }))
                          )
                        case 'tweet':
                          return (
                            i(),
                        ...
                        case 'via':
                          return void window.navigator
                            .share({ text: e.text, url: Object(w.a)(e.url) })
                            .then(i)
                            .catch(function () {
                              n.analytics.scribe(c()(c()({}, n.mergedScribeNamespace), {}, { action: 'share_error' }))
                            })
                        default:
                          Object(A.a)('[ShareButton] Unexpected share type ['.concat(t, ']'))
                      }
                    })(r.type, l, p)
                  }
                  return r.label && (l.text = r.label), c()(c()({}, l), {}, { onClick: p })
                }
              },
              [e, n, i, t.scribeNamespace, t.shareText, t.url],
            )
          })(t, e),
          analytics: e,
        }
      }
      var x = { copyLinkSuccessMessage: p.a.f88553c8, shareTextPrefixFormatter: p.a.gb5851d7 }
      function L(t) {
        var e = t.url,
          n = t.text
        return { query: { text: n ? x.shareTextPrefixFormatter({ prefix: n, url: e }) : e } }
      }
      var R = n('mN6z')
      var D = n('mjJ+'),
        F = n('rHpw'),
      ...
      function U(t) {
        var e = (function (t) {
            var e = r.a.useRef({ previous: void 0 })
            function n(t) {
              return (e.current.previous = t), t
            }
            var i = e.current.previous
            return i && (t === i || Object(R.a)(t, i)) ? i : n(t)
          })(c()(c()({}, M), t.scribeNamespace)),
          n = k(c()(c()({}, t), {}, { scribeNamespace: e })),
          i = n.analytics,
          a = n.getActionItem
        var o = t.ButtonComponent || q
        return r.a.createElement(o, {
          onPress: function () {
            var t = c()(c()({}, e), {}, { action: 'share_menu_click' })
            i.scribe(t)
          },
          ...
          renderMenu: function (e) {
            ...
            return (
              t.children
                ? r.a.Children.forEach(t.children, function (t) {
                    if (r.a.isValidElement(t)) {
                      var e = a(t.props)
                      e && n.push(e)
                    }
                  })
                : ['tweet', 'dm', 'copy', 'via'].forEach(function (t) {
                    var e = a({ type: t })
                    e && n.push(e)
                  }),
              r.a.createElement(D.a, { isFixed: t.isFixed, items: n, onCloseRequested: e, shouldCloseOnClick: !0 })
            )
          },
        })
      }
      function q(t) {
        return r.a.createElement(v, s()({}, t, { style: B.button, testID: m }))
      }
      var B = F.a.create(function (t) {
          return { button: { marginRight: t.spaces.space4 } }
        }),
        H = ['copyLinkShareLabel', 'dmShareLabel', 'externalShareLabel', 'tweetShareLabel']
      function X(t) {
        var e = t.copyLinkShareLabel,
          n = t.dmShareLabel,
          i = t.externalShareLabel,
          o = t.tweetShareLabel,
          s = b()(t, H)
        return r.a.createElement(
          U,
          s,
          r.a.createElement(a, { label: o, type: 'tweet' }),
          r.a.createElement(a, { label: n, type: 'dm' }),
          r.a.createElement(a, { label: e, type: 'copy' }),
          r.a.createElement(a, { label: i, type: 'via' }),
        )
      }
      ;(X.Action = a), (X.Custom = U)
      e.a = X
    },
    MQi0: function (t, e, n) {
      'use strict'
    ...
    WrBE: function (t, e, n) {
            ...
            (u.render = function () {
              var n,
                ...
                d = (
                  ...
                  : {}
              return r.createElement(t, E({}, u, f, d, { style: _, ref: this._setComponentRef }))
            }),
      ...
      var B = R(
          r.forwardRef(function (t, e) {
            return r.createElement(U.a, q({ scrollEventThrottle: 1e-4 }, t, { ref: e }))
          }),
          { collapsable: !1 },
        ),
        H = n('MWbm'),
        ...
        Bt = function t(e, n) {
          var i = function (t, e, n) {
            ...
            var i = t,
              r = e
            i.stopTracking(),
              e.toValue instanceof _.a ? i.track(new Ct(i, e.toValue, Rt.a, r, n)) : i.animate(new Rt.a(r), n)
          }
          return (
            qt(e, n, t) || {
              start: function (t) {
        ...
        spring: function t(e, n) {
          var i = function (t, e, n) {
            ...
            var i = t,
              r = e
            i.stopTracking(),
              e.toValue instanceof _.a ? i.track(new Ct(i, e.toValue, Lt.a, r, n)) : i.animate(new Lt.a(r), n)
          }
          return (
            qt(e, n, t) || {
              start: function (t) {
      ...
      var Kt = {
        ...
        Zt = {
          ...
          add: Jt.add,
          subtract: Jt.subtract,
          divide: Jt.divide,
          multiply: Jt.multiply,
          modulo: Jt.modulo,
          diffClamp: Jt.diffClamp,
          delay: function (t) {
            return Kt
          },
          sequence: function (t) {
          ...
          createAnimatedComponent: R,
          attachNativeEvent: p,
          forkEvent: Jt.forkEvent,
          unforkEvent: Jt.unforkEvent,
          Event: f,
          __PropsOnlyForTests: P,
        }
      function Qt(t, e) {
      ...
      var te = (function (t) {
        ...
        return t
      })({ FlatList: F, Image: M, ScrollView: B, SectionList: ft, Text: _t, View: ht }, i.a.isTesting ? Zt : Jt)
      e.a = te
    },
    XJEr: function (t, e, n) {
      'use strict'
        ...
        var c = (function (e) {
          ...
          function a(t) {
            ...
            if (
              ...
              (_._initialVelocity = null !== (u = t.velocity) && void 0 !== u ? u : 0),
              (_._lastVelocity = null !== (c = t.velocity) && void 0 !== c ? c : 0),
              ...
              ;(_._stiffness = N.stiffness), (_._damping = N.damping), (_._mass = 1)
            }
            return (
          ...
          return (
            ...
            (c.onUpdate = function () {
              ...
              if (o < 1) {
                ...
                ;(l = this._toValue - _ * (((a + o * s * c) / u) * Math.sin(u * f) + c * Math.cos(u * f))),
                  (p =
                    o * s * _ * ((Math.sin(u * f) * (a + o * s * c)) / u + c * Math.cos(u * f)) -
                    _ * (Math.cos(u * f) * (a + o * s * c) - u * c * Math.sin(u * f)))
              } else {
                var h = Math.exp(-s * f)
                ;(l = this._toValue - h * (c + (a + s * c) * f)), (p = h * (a * (f * s - 1) + f * c * (s * s)))
              }
              if (
                ((this._lastTime = t),
