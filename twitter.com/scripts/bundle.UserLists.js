            ...
            return (
              ...
              v()(u()(a), '_handleSaveAddToLists', function () {
                ...
                a.state.listsToAddTo.forEach(function (e) {
                  e && r && t({ userId: r.id_str, listId: e }).catch(n({}))
                })
              }),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.state.listsToRemoveFrom.forEach(function (e) {
                    e && a && n({ userId: a.id_str, listId: e }).catch(t({}))
                  })
                },
              },
            ]),
            ...
            u()(this, n),
              ...
              _()(m()(o), 'save', function () {
                ...
                if ((o._hasMediaChanged() && d && h.push(o._handleUploadMedia(d)), o._hasListDataChanged() && p)) {
                  var f = u({ description: t, listId: p, mode: n ? te : ee, name: a }).catch(
                    c(
              ...
              return (
                ...
                r()(p()(e), '_handleAdd', function () {
                  var t = e.props,
                    ...
                    s = t.userId
                  i()
                    ? (n({ listId: r, userId: s, shouldInjectURTEntry: !1 })
                        .then(function () {
                          o && o(s)
                        })
                        .catch(a(b.a)),
                ...
                r()(p()(e), '_handleRemove', function () {
                  var t = e.props,
                    ...
                    i = t.userId
                  o({ listId: a, userId: i, shouldRemoveURTEntry: !1 })
                    .then(function () {
                      r && r(i)
                    })
                    .catch(n()),
          ...
          function n(e) {
            ...
            return (
              ...
              m()(c()(a), '_handleListFetch', function () {
                var e = a.props,
                  t = e.createLocalApiErrorHandler
                ;(0, e.fetchListIfNeeded)(e.listId || '', { screenName: e.screenName, slug: e.slug }).catch(function (
                  e,
                ) {
    ...
    'f5/l': function (e, t, n) {
      ...
      var a = n('Ox2E'),
        r = function (e, t, n, r, o, i) {
          t
            ? (o({ listId: n }).catch(e(a.c)), i && i({ element: 'unsubscribed', action: 'click' }))
            : (r({ listId: n }).catch(e(a.b)), i && i({ element: 'subscribed', action: 'click' }))
        },
        o = function (e, t) {
