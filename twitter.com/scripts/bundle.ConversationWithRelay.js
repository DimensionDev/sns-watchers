  ...
  [48],
  {
    ...
    DL4F: function (e, t, a) {
      ...
      function dt(e) {
        ...
        var i = w.a.createElement(qe.a, We()({}, r, { containerStyle: mt.infoItem })),
          l = null !== Object(D.a)(),
          o = ''
            .concat(e.tweetPermalink, '/')
            .concat(l ? lt.a.Webview : lt.a.Rweb, '/')
            .concat(lt.c.Intro)
      ...
      function Bt(e) {
        ...
        switch (l) {
          ...
          case Ft.notStarted:
            return w.a.createElement(kt, { tweetPermalink: o.permalink, userId: e.userId })
          case Ft.underReview:
