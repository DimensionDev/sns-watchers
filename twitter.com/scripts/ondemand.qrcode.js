      ...
      var r = {
        single_source_shortest_paths: function (t, e, n) {
          ...
          var s,
            ...
            f,
            h,
            g = r.PriorityQueue.make()
          for (g.push(e, 0); !g.empty(); )
            for (a in ((u = (s = g.pop()).value), (c = s.cost), (l = t[u] || {})))
              l.hasOwnProperty(a) &&
                ((f = c + l[a]), (h = i[a]), (void 0 === i[a] || h > f) && ((i[a] = f), g.push(a, f), (o[a] = u)))
    ...
    Wzsi: function (t, e, n) {
      ...
      function m(t, e, n) {
        ...
        return (function (t, e, n) {
          ...
          for (let r = 0; r < u; r++) {
            const t = r < a ? h : g
            ;(m[r] = B.slice(w, w + t)), (E[r] = p.encode(m[r])), (w += t), (y = Math.max(y, t))
          }
          const A = new Uint8Array(o)
          let C,
            I,
            T = 0
          for (C = 0; C < y; C++) for (I = 0; I < u; I++) C < m[I].length && (A[T++] = m[I][C])
          for (C = 0; C < d; C++) for (I = 0; I < u; I++) A[T++] = E[I][C]
          return A
        })(o, t, e)
      }
      function E(t, e, n, o) {
                ...
                for (let t = 0; t < u.length; t++) {
                  ...
                  for (let t = 0; t < i.length; t++) {
                    ...
                    n[s] && n[s].node.mode === c.mode
                      ? ((o[s][l] = d(n[s].lastCount + c.length, c.mode) - d(n[s].lastCount, c.mode)),
                        (n[s].lastCount += c.length))
                      : (n[s] && (n[s].lastCount = c.length),
                        (o[s][l] = d(c.length, c.mode) + 4 + r.getCharCountIndicator(c.mode, e)))
                  }
                }
                i = a
              }
