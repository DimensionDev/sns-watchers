    ...
    '0FX9': function (t, e, n) {
      ...
      function u(t, e, n, i, s) {
        ...
        if (!c) {
          ...
          return (
            1 === a ? ((n = e), (e = i = void 0)) : 2 !== a || e.getContext || ((i = n), (n = e), (e = void 0)),
        ...
        2 === a
          ? ((s = n), (n = e), (e = i = void 0))
          : 3 === a &&
            (e.getContext && void 0 === s ? ((s = i), (i = void 0)) : ((s = i), (i = n), (n = e), (e = void 0)))
        try {
      ...
      var r = {
        single_source_shortest_paths: function (t, e, n) {
          ...
          for (d.push(e, 0); !d.empty(); )
            for (a in ((u = (s = d.pop()).value), (c = s.cost), (l = t[u] || {})))
              l.hasOwnProperty(a) &&
                ((f = c + l[a]), (h = i[a]), (void 0 === i[a] || h > f) && ((i[a] = f), d.push(a, f), (o[a] = u)))
              ...
              for (let a = 0; a < t.length; a++) {
                ...
                c || s || (s = !0),
                  t[a]
                    ? (u++,
                      (a > 0 && c > 0 && t[a - 1]) ||
                        ((r += s ? i('M', c + n, 0.5 + l + n) : i('m', o, 0)), (o = 0), (s = !1)),
                      (c + 1 < e && t[a + 1]) || ((r += i('h', u)), (u = 0)))
                    : o++
              }
              return r
            })(a, u, s.margin) +
          ...
          for (let e = 0; e < u; e++)
            for (let n = 0; n < u; n++) {
              ...
              if (e >= a && n >= a && e < u - a && n < u - a) {
                f = c[i[Math.floor((e - a) / s) * o + Math.floor((n - a) / s)] ? 1 : 0]
              }
      ...
      ;(e.isValid = function (t) {
        ...
        (e.getPenaltyN1 = function (t) {
          ...
          for (let a = 0; a < e; a++) {
            ...
            for (let c = 0; c < e; c++) {
              let e = t.get(a, c)
              e === s ? o++ : (o >= 5 && (r += n + (o - 5)), (s = e), (o = 1)),
                (e = t.get(c, a)),
                e === u ? i++ : (i >= 5 && (r += n + (i - 5)), (u = e), (i = 1))
            }
        ...
        (e.getPenaltyN3 = function (t) {
          ...
          for (let o = 0; o < e; o++) {
            r = i = 0
            for (let s = 0; s < e; s++)
              (r = ((r << 1) & 2047) | t.get(o, s)),
                s >= 10 && (1488 === r || 93 === r) && n++,
                (i = ((i << 1) & 2047) | t.get(s, o)),
                s >= 10 && (1488 === i || 93 === i) && n++
          }
          return n * o
        }),
    ...
    qmMu: function (t, e, n) {
      ...
      function m(t, e, n) {
        ...
        return (function (t, e, n) {
          ...
          for (let r = 0; r < u; r++) {
            const t = r < a ? h : d
            ;(m[r] = A.slice(w, w + t)), (E[r] = p.encode(m[r])), (w += t), (y = Math.max(y, t))
          }
          const C = new Uint8Array(o)
          let B,
            v,
            M = 0
          for (B = 0; B < y; B++) for (v = 0; v < u; v++) B < m[v].length && (C[M++] = m[v][B])
          for (B = 0; B < g; B++) for (v = 0; v < u; v++) C[M++] = E[v][B]
          return C
        })(o, t, e)
      }
      function E(t, e, n, o) {
        ...
        return (
          ...
          isNaN(o) && (o = c.getBestMask(g, w.bind(null, g, n))),
          c.applyMask(o, g),
          w(g, n, o),
          { modules: g, version: e, errorCorrectionLevel: n, maskPattern: o, segments: i }
        )
      }
    ...
    vvrf: function (t, e, n) {
      ...
      function d(t) {
        ...
        c.isKanjiModeEnabled()
          ? ((o = h(a.BYTE, r.BYTE, t)), (i = h(a.KANJI, r.KANJI, t)))
          : ((o = h(a.BYTE_KANJI, r.BYTE, t)), (i = []))
        return e
          .concat(n, o, i)
          .sort(function (t, e) {
      ...
      function p(t, e) {
        ...
        if (((n = r.from(e, a)), n !== r.BYTE && n.bit < a.bit))
          throw new Error(
          ...
          const o = (function (t, e) {
              ...
              for (let s = 0; s < t.length; s++) {
                ...
                for (let t = 0; t < u.length; t++) {
                  const c = u[t],
                    l = '' + s + t
                  a.push(l), (n[l] = { node: c, lastCount: 0 }), (o[l] = {})
                  for (let t = 0; t < i.length; t++) {
                    const s = i[t]
                    n[s] && n[s].node.mode === c.mode
                      ? ((o[s][l] = g(n[s].lastCount + c.length, c.mode) - g(n[s].lastCount, c.mode)),
                        (n[s].lastCount += c.length))
                      : (n[s] && (n[s].lastCount = c.length),
                        (o[s][l] = g(c.length, c.mode) + 4 + r.getCharCountIndicator(c.mode, e)))
                  }
                }
                i = a
              }
                ...
                for (let n = 0; n < t.length; n++) {
                  ...
                  switch (o.mode) {
                    ...
                    case r.ALPHANUMERIC:
                      ...
                      break
                    case r.KANJI:
                      e.push([o, { data: o.data, mode: r.BYTE, length: f(o.data) }])
                      break
                    case r.BYTE:
            ...
            s = []
          for (let e = 1; e < i.length - 1; e++) s.push(o.table[i[e]].node)
          return e.fromArray(
            (function (t) {
              return t.reduce(function (t, e) {
