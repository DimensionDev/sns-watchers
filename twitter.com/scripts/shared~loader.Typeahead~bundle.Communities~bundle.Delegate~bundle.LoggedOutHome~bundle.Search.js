                  ...
                  var e = this.props,
                    ...
                    W = g.a.createElement(C.a.Consumer, null, function (e) {
                      ...
                      return m
                        ...
                        : g.a.createElement(L.default, a()({ size: t }, B))
                    }),
                    G = n && 'boolean' == typeof n.checked,
                    Y = void 0 !== f,
                    K = (G ? 'radio' : Y && 'button') || 'listitem',
      ...
      t.b = function (e) {
        ...
        if (t) {
          ...
          var M = i.a.createElement(
            h.b,
            { color: C, numberOfLines: 1, size: x, weight: S },
            Object(y.a)(t, m, r, L ? 2 : void 0),
          )
          return (L && !r) || l
            ? i.a.createElement(
                d.a,
      ...
      var X = R.a.create(function (e) {
        ...
        J = function (e) {
              ...
              a
                ? y.a.createElement(
                    ...
                    a && a.types[0] && 'followable_topic' === a.types[0].type
                      ? y.a.createElement(K.a, { style: X.icon })
                      : null,
          ...
          return y.a.createElement(
            ...
            o
              ? (function (e) {
                  var t = y.a.createElement(Y.a, { Icon: Q.a, color: 'neutral', size: 'xxxLarge', style: X.searchIcon })
                  return y.a.createElement(
                    k.a,
                    {
                      avatarCell: t,
      ...
      t.a = function (e) {
        var t = function (t) {
            ...
            return a.a.createElement(
              ...
              a.a.createElement(f.default, { size: n || 'xxLarge', uri: t.profile_image_url_https }),
            )
          },
          n = function (e) {
            var t = e.length,
      ...
      var h = function () {
        ...
        switch (s.length) {
          ...
          case 1:
            var c = a()(s, 1),
              l = c[0]
            return n === i.a.GROUP ? p({ name: l }) : l
          default:
            var u = !0,
              h = Object(o.a)(s.slice(0, r), u)
            return r ? f({ listOfParticipants: h, count: s.length - r }) : h
        }
      }
    },
    tAeL: function (e, t, n) {
