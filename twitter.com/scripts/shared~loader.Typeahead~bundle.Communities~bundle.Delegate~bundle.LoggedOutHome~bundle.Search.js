      ...
      var a = n('VrFO'),
        ...
        A = function (e) {
          return E.a.isTwoColumnNormalLayout(e)
            ? {
                width: b.a.columnWidths.secondary.normal + F.a.theme.spacesPx.space24,
                left: -F.a.theme.spacesPx.space24 / 2,
              }
            : E.a.isTwoColumnSmallLayout(e)
            ? {
                width: b.a.columnWidths.secondary.small + F.a.theme.spacesPx.space16,
                left: -F.a.theme.spacesPx.space16 / 2,
              }
            : void 0
        },
        H = 1,
            ...
            return (
              ...
              m()(c()(o), '_renderDropdown', function (e) {
                var t = o.props,
                  ...
                  O = e >= F.a.theme.breakpoints.medium || Object(S.a)(),
                  U = o.state,
                  P = U.dropdownOffset,
                  j = U.query,
                  M = p
                    ...
                    : [
                        V.dropdown,
                        !O && R && P ? [Object(N.d)(P), { height: 'calc(100vh - '.concat(P, 'px)') }] : null,
    ...
    OEYw: function (e, t, n) {
        ...
        W = function (e, t) {
          ...
          return (
            null != t && t.communityId
              ? (o = ''.concat(a, '_').concat(t.communityId))
              : null != t && t.trustedFriendsId && (o = ''.concat(a, '_').concat(t.trustedFriendsId)),
        ...
        J = function (e, t) {
          return function (n, a, r) {
            ...
            var i = { queryId: W(e, t) },
              ...
              d = e.result_type.split(','),
              u = { actionTypes: B, context: 'FETCH_TYPEAHEAD', meta: i }
            if (d.includes(A.a.CommunityUsers) && c) {
              return Object(O.b)(n, {
            ...
            if (d.includes(A.a.CommunityMembers) && c) {
              return Object(O.b)(n, {
                params: { communityId: c, prefix: e.q },
            ...
            return d.includes(A.a.TrustedFriendsSuggested) && l
              ? Object(O.b)(n, {
                  params: { trustedFriendsId: l, prefix: e.q },
                  request: o.Typeahead.fetchTrustedFriendsSuggestions,
                })(u)
              : Object(O.b)(n, { params: e, request: o.Typeahead.fetch })(u)
          }
        }
      M.a.register(
        b()({}, V, function () {
      ...
      var Z = n('UQTn'),
        ...
        ee = function (e) {
          ...
          return W({ q: a, result_type: (n || $).join(','), src: r }, { communityId: t, trustedFriendsId: o })
        },
        te = function (e, t) {
          return (function (e, t) {
            var n = G(e, t)
            ...
            },
            {
              ...
              value: function () {
                ...
                switch (o.type) {
                  case oe.b.User:
                    var l = o.data,
                      d = s ? s({ userId: l.id_str, user: l, isSelected: r }) : void 0,
                      u = n ? n(o, l) : void 0
