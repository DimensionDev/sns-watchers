  ...
  ],
  {
    ...
    892205: function _(e, t, r) {
            ...
            return (
              ...
              (0, d.Z)((0, o.Z)(i), '_render', function () {
                ...
                return a
                  ? u.createElement(
                      h.Z,
                      { style: Ne.emptyState, testID: Ae.Z.typeaheadEmptySearch },
                  ...
                  : u.createElement(
                      ...
                      n.length > 0
                        ? u.createElement(
                            ...
                            u.createElement(
                              h.Z,
                              { style: Ne.header, testID: Ae.Z.typeaheadRecentSearchesHeader },
      ...
      var $e = (0, B.Z)().propsFromState(function () {
        ...
        Ye = 'SearchBox_Search_Input'
      var Je = v().ib2e46ee,
        Xe = v().hbc99b03,
        et = /^(\w+)$/,
        tt = [g.my.Events, g.my.Users, g.my.Topics],
        rt = function rt(e) {
          ...
          function r(e, i) {
            ...
            return (
              ...
              (0, d.Z)((0, o.Z)(l), '_renderSearchBoxEmptyState', function (e) {
                return u.createElement(Me, (0, n.Z)({}, e, { onItemClick: l._handleSearchItemClick }))
              }),
    ...
    954813: function _(e, t, r) {
      ...
      var s = function s(e) {
        var t = e.description,
          ...
          f = (0, o.H)({ description: t, entities: r, withheldDescription: h, withheldEntities: m }),
          v = f.description,
          p = f.entities,
          y = i.ZP.descriptionTextParts(v, p)
        return y.length
          ? a.createElement(
              n.ZP,
              { dir: 'auto', numberOfLines: s ? 2 : void 0, style: l, testID: d },
              y.map(function (e, t) {
                return a.createElement(c.ZP, { key: 'user_'.concat(u, '_textpart_').concat(t), linkify: !0, part: e })
              }),
            )
          : null
      }
